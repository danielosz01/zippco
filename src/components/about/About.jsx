              ...
              <div className="u-container-layout u-container-layout-1">
                ...
                <div className="u-social-icons u-spacing-10 u-social-icons-1">
                  <a className="u-social-url" target="_blank" href="">
                    <span className="u-icon u-icon-circle u-social-facebook u-social-icon u-text-palette-1-base u-icon-1">
                      {/* <svg
                  ...
                  <a className="u-social-url" target="_blank" href="">
                    <span className="u-icon u-icon-circle u-social-icon u-social-twitter u-text-palette-1-base u-icon-2">
                      {/* <svg
                        className="u-svg-link"
                        preserveAspectRatio="xMidYMin slice"
                        viewBox="0 0 112 112"
                  ...
                  <a className="u-social-url" target="_blank" href="">
                    <span className="u-icon u-icon-circle u-social-icon u-social-instagram u-text-palette-1-base u-icon-3">
                      {/* <svg
                        className="u-svg-link"
                        preserveAspectRatio="xMidYMin slice"
                        viewBox="0 0 112 112"
            ...
            <div className="u-container-style u-layout-cell u-size-20 u-layout-cell-3">
              <div className="u-container-layout u-container-layout-3">
                ...
                <div className="u-social-icons u-spacing-10 u-social-icons-3">
                  <a className="u-social-url" target="_blank" href="">
                    <span className="u-icon u-icon-circle u-social-facebook u-social-icon u-text-palette-4-base u-icon-7">
                      {/* <svg
                        className="u-svg-link"
                        preserveAspectRatio="xMidYMin slice"
                        viewBox="0 0 112 112"
                  ...
                  <a className="u-social-url" target="_blank" href="">
                    <span className="u-icon u-icon-circle u-social-icon u-social-twitter u-text-palette-4-base u-icon-8">
                      {/* <svg
                        className="u-svg-link"
                        preserveAspectRatio="xMidYMin slice"
                        viewBox="0 0 112 112"
                  ...
                  <a className="u-social-url" target="_blank" href="">
                    <span className="u-icon u-icon-circle u-social-icon u-social-instagram u-text-palette-4-base u-icon-9">
                      {/* <svg
                        className="u-svg-link"
                        preserveAspectRatio="xMidYMin slice"
                        viewBox="0 0 112 112"
